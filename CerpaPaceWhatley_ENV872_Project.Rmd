...
After that using the anova data for heat and cool degrees we created tables for both dependent variables using the Kable function. With this we were able to learn a few things, firstly that for Nevada’s heating degree, all variables Location, Year, and Location:Year we’re statically significant. While the same story was told when looking at the cooling degree vairble, all variables being statically significant. Causing us to infer that all of these factors do indeed have caused the trend in higher and colder temperatures in Nevada, explained that climate change just might be the cause.

Secondly, looking at the table for Arizona, we find that this data tells a slightly different story than Nevada. That is for heating degree, Location and Year are both statically significant while Location:Year isn’t due to it having a p-value of 0.054 compared to the 0 P-value Location and Year both have. Meanwhile for the cooling degree, all variables were statically significant.

Lastly, from California’s data we learn that again for heat degrees, Location and Year are both statically significant while Location:Year did not having a P-value of 0.65. All variables for cooling degree were significant.
...
In summary, with anova testing we learned that Location, Year and Location:Year play were the biggest contributor to average heat and cooling degrees for each state. Excluding the Location:Year variable for heating degree in Arizona and California which weren’t statically significant. 
...
(Question 1)... ANOVA testing allowed us to ascertain that Location, Year and Location:Year play were the biggest contributor to average heat and cooling degrees for each state. Excluding the Location:Year variable for heating degree in Arizona and California which weren’t statically significant. It is worthy to note though that when filtering the datasets, Arizona and California had few decades less of data coverage compared to Nevada... (Question 3)
