...
We then extracted the f-values from those datasets and create a bar charts to visualize the stark difference between statically significant variables compared to the other variables.
